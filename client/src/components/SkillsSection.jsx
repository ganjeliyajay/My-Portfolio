...
export const SkillsSection = () => {
  ...
  return (
    <section id="skills" className="py-24 px-8 relative bg-background">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {filteredSkills.map((skill, key) => (
            <div
              key={key}
              className={cn(
                "p-6 rounded-xl shadow-md transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg bg-card border border-border"
              )}
            >
